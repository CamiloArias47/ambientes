...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_cropperjs__ = __webpack_require__(13);
...
var Helpers = __webpack_require__(14); //incluir el archivo que contine funciones peara diferentes fines
var helper = new Helpers();

var chosenSelectStyle = { width: "350px" },
...
var Main = function (_React$Component) {
	...
	function Main(props) {
		...
		_this.state = { pageForm: 'first', //renderiza un formulario, "first" los datos iniciales, "second" para agregar imagenes
			...
			products: _this.props.products, //productos a mostrar en la pestaña productos
			...
			prev: _this.props.prev, //indica si debe mostrar el boton de anterior
		...
		_this.finishCreate = _this.finishCreate.bind(_this);
		_this.showModalEdit = _this.showModalEdit.bind(_this); //maneja el onCLick de los botones de editar, para mostrar el modal
		_this.submitEdit = _this.submitEdit.bind(_this); //maneja el onSubmit del formulario de editar
		_this.finishUpdate = _this.finishUpdate.bind(_this); //cambia el state pageFormEdit a firsdt
		_this.filter = _this.filter.bind(_this); //maneja el onChange de los filtros de productos
		_this.handlerPrev = _this.handlerPrev.bind(_this); //maneja el onClick del boton prev
		return _this;
	}
	...
	_createClass(Main, [{
		...
		key: 'renderAForm',
		value: function renderAForm() {
			if (this.state.pageForm == "first") {
				return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(FormCreate, { fatherCategories: this.props.fatherCategories,
				...
				return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(FormImages, { defaultImg: this.props.defaultImg,
		...
		key: 'finishCreate',
		value: function finishCreate(ev) {
			ev.preventDefault();
			$.ajax({
		...
		value: function finishUpdate() {
			...
			$.ajax({
				...
				success: function (response) {
					...
					if (response.exist) {
						var newProd = [];
						this.state.products.forEach(function (prod) {
							if (_this2.state.productEdit.id == prod.id && prod.type == _this2.state.productEdit.type) {
		...
		key: 'showModalEdit',
		value: function showModalEdit(e) {
			var _this3 = this;
			...
			this.state.products.forEach(function (product) {
				if (product.id == id) {
					_this3.setState({ productEdit: product }); //establecer el producto cliqueado para editar en el state productEdit
				}
			});
		...
		key: 'renderOptFatherCategories',
		value: function renderOptFatherCategories() {
			var opt = [];
			this.props.fatherCategories.forEach(function (fat) {
				opt.push(__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
					'option',
					{ value: fat.id, key: "optFath-" + fat.id },
					fat.name
				));
			});
			return opt;
		...
		key: 'renderOptCategories',
		value: function renderOptCategories() {
			var opt = [];
			this.state.optCategories.forEach(function (cat) {
				opt.push(__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
					'option',
					{ value: cat.id, key: "optCate-" + cat.id },
					cat.name
				));
			});
			return opt;
		...
		key: 'renderOptSubCategories',
		value: function renderOptSubCategories() {
			var opt = [];
			this.state.optSubCatego.forEach(function (sub) {
				opt.push(__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
					'option',
					{ value: sub.id, key: "optSub-" + sub.id },
					sub.name
				));
			});
			return opt;
		...
		key: 'ajaxGetCategories',
		value: function ajaxGetCategories(id) {
			$.ajax({
		...
		key: 'ajaxGetSubCategories',
		value: function ajaxGetSubCategories(id) {
			$.ajax({
		...
		value: function render() {
			return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
				...
				__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
					...
					__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
						...
						__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
							...
							__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
								'a',
								{ href: '#tProducts', className: 'active' },
								' Productos'
							)
						),
						__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
				...
				__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
					'div',
					{ id: 'tProducts', className: 'col s12' },
					__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
						'div',
						...
						__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
							...
							__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
								...
								__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
									...
									__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
										...
										__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
											'select',
											{ className: 'form-control', name: 'filterFather', id: 'filterFather', onChange: this.filter },
											__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
												'option',
												{ value: '' },
												'Categoria padre'
									...
									__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
										...
										__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
											'select',
											{ className: 'form-control', name: 'filterCategory', id: 'filterCategory', onChange: this.filter },
											__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
												'option',
												{ value: '' },
												'Categoria'
									...
									__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
										...
										__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
											'select',
											{ className: 'form-control', name: 'filterSubCate', id: 'filterSubCate', onChange: this.filter },
											__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
												'option',
												{ value: '' },
												'Subcategoria'
									...
									__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
										...
										__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
											...
											__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('input', { type: 'text', className: 'input form-control', name: 'filterName', id: 'filterName', onChange: this.filter }),
											__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
												'span',
												{ className: 'input-group-btn' },
												__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
													'button',
													{ type: 'button', className: 'btn btn btn-primary', id: 'btn-ir' },
													__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
														'span',
														null,
														this.state.gifFilter == true ? __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('i', { className: 'fa fa-spinner fa-spin', 'aria-hidden': 'true' }) : " Ir"
													)
												)
											)
										)
							...
							__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(ProducPanel, { products: this.state.products,
								defaultImg: this.props.defaultImg,
								showModalEdit: this.showModalEdit }),
							__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
								'div',
								{ className: 'col-md-12 m-t' },
								__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
									'div',
									{ className: 'col-md-4 col-md-offset-5' },
									this.state.next == true ? __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
										'button',
										{ className: 'btn btn-default', 'data-order': 'next', 'data-position': this.state.products[0]["created_at"], onClick: this.handlerPrev },
										"<"
									) : "",
									this.state.prev == true ? __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
										'button',
										{ className: 'btn btn-default', 'data-order': 'prev', 'data-position': this.state.products[this.state.products.length - 1]["created_at"], onClick: this.handlerPrev },
										'>'
									) : ""
								)
							)
				...
				__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
					'div',
					{ id: 'tCreateProduct', className: 'col s12' },
					__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
						'div',
						{ className: 'panel-body' },
						this.renderAForm()
				...
				__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(ModalEdit, { fatherCategories: this.props.fatherCategories,
					routeGetCategories: this.props.routes.getCategories,
					routeGetSubCategories: this.props.routes.getSubCategories,
					routeProductsOfAccessory: this.props.routes.productsOfAccessory,
					routeQuitTag: this.props.routes.routeQuitTag,
...
var ProducPanel = function (_React$Component2) {
	_inherits(ProducPanel, _React$Component2);

	function ProducPanel() {
		_classCallCheck(this, ProducPanel);

		return _possibleConstructorReturn(this, (ProducPanel.__proto__ || Object.getPrototypeOf(ProducPanel)).apply(this, arguments));
	}

	_createClass(ProducPanel, [{
		key: 'buildProducts',
		value: function buildProducts() {
			...
			this.props.products.forEach(function (product) {
				...
				row.push(__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(Produt, { product: product,
					defaultImg: _this5.props.defaultImg,
					key: "content-product" + product.id,
					showModalEdit: _this5.props.showModalEdit }));

				iteracion++;
				if (iteracion == 5) {
					productos.push(__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
						'div',
						{ className: 'row', key: "rowProduct-" + iteracion + "-" + product.id },
						row
					));
					iteracion = 1;
					row = [];
			...
			if (iteracion <= 4) {
				//si no se completo la fila
				productos.push(__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
					'div',
					{ className: 'row', key: "rowProduct-" + iteracion + "-lastIncomplete" },
					row
				));
			}
...
var Produt = function (_React$Component3) {
	_inherits(Produt, _React$Component3);

	function Produt() {
		_classCallCheck(this, Produt);

		return _possibleConstructorReturn(this, (Produt.__proto__ || Object.getPrototypeOf(Produt)).apply(this, arguments));
	}
				...
				__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
					...
					__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
						...
						__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
							...
							__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('img', { className: 'img-responsive', src: this.props.product[images].length > 0 ? this.props.product[images][0].route : this.props.defaultImg })
						),
						__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
							'div',
							...
							__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
								...
								__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
									'small',
									null,
									this.props.product.showprice == "no" ? "No visible " : ""
								),
								'$',
							...
							__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
								...
								this.props.product.shop_subcategory.shop_category.shop_fathercategory.name + " / " + this.props.product.shop_subcategory.shop_category.name + " / " + this.props.product.shop_subcategory.name
							),
							__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
								'a',
								{ href: this.props.product.detail, className: 'product-name' },
								' ',
							...
							__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
								...
								__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
									'div',
									{ id: "full-height-scroll-" + this.props.product.id },
									__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
										'div',
										{ className: 'small m-t-xs' },
							...
							__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
								'div',
								{ className: 'm-t text-righ' },
								__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
									'button',
									{ className: 'btn btn-xs btn-outline btn-primary', 'data-id': this.props.product.id, onClick: this.props.showModalEdit },
									' Editar'
								),
								__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
									'a',
									{ href: this.props.product.detail, target: '_blank', className: 'btn btn-xs btn-outline btn-primary' },
									'Mas ',
...
var FormCreate = function (_React$Component4) {
	_inherits(FormCreate, _React$Component4);

	function FormCreate(props) {
		_classCallCheck(this, FormCreate);

		var _this7 = _possibleConstructorReturn(this, (FormCreate.__proto__ || Object.getPrototypeOf(FormCreate)).call(this, props));

		_this7.state = { 'type': _this7.props.productEdit != null ? _this7.props.productEdit.type : "",
			'valueFathercate': _this7.props.productEdit != null && _this7.props.editOrCreate == "edit" ? _this7.props.productEdit.shop_subcategory.shop_category.shop_fathercategory.id : "", //el valor del value del delect de father category
			...
			'valueMetaDescription': _this7.props.productEdit != null && _this7.props.editOrCreate == "edit" ? _this7.props.productEdit.meta_description : "",
		...
		_this7.handlerChangeFatherCategory = _this7.handlerChangeFatherCategory.bind(_this7); //funcion que maneja el onChange del input #createProductFatherCategory para mostrar el campo de otra categoria padre
		_this7.handlerChangeCategory = _this7.handlerChangeCategory.bind(_this7); //maneja el onCHange del select de categorias
		_this7.handlerChangeSubCategory = _this7.handlerChangeSubCategory.bind(_this7); //maneja en onChange del select de subcategorias
		_this7.handlerChangeBrand = _this7.handlerChangeBrand.bind(_this7); //maneja el onChange del select de marcas
		_this7.handlerChangeMoreTags = _this7.handlerChangeMoreTags.bind(_this7); //maneja el onCHange del option más tags
		_this7.handlerChangeMetaDescription = _this7.handlerChangeMetaDescription.bind(_this7);
		_this7.handlerChangeName = _this7.handlerChangeName.bind(_this7); //maneja el onChange de input nombre
		_this7.handlerChangePrice = _this7.handlerChangePrice.bind(_this7); //maneja el onChange del input de precio
		_this7.handlerChangeTypeAccessory = _this7.handlerChangeTypeAccessory.bind(_this7); //maneja el onChange del switch que indica si es un accesorio
		_this7.handlerChangeHaveAccessory = _this7.handlerChangeHaveAccessory.bind(_this7); //maneja el onClick del switch que indica si el producto tiene accesorios
		_this7.ajaxDeleteProductOfAccessory = _this7.ajaxDeleteProductOfAccessory.bind(_this7); //maneja peticiones ajax para quitar un producto que se le asigno a un accesorio
		_this7.ajaxQuitTag = _this7.ajaxQuitTag.bind(_this7); //realiza peticiones ajax-post para eliminar un tag de un producto o accesorio
		_this7.ajaxQuitAccessory = _this7.ajaxQuitAccessory.bind(_this7); //realiza peticiones post-ajax para quitar un accesorio de un producto
		return _this7;
	}
	...
	_createClass(FormCreate, [{
		key: 'handlerChangeFatherCategory',
		value: function handlerChangeFatherCategory(ev) {
			var optSelected = ev.target.value;
			if (optSelected != "otro" && optSelected != "") {
				//si el valor seleccionano no es "otro" o ninguno
		...
		key: 'toggleInputOtherFatherCategory',
		value: function toggleInputOtherFatherCategory() {
			if (this.state.otherFather) {
				return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
					'div',
					{ className: 'row m-t-xs' },
					__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
						'div',
						{ className: 'col-md-6' },
						__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
							'label',
							{ htmlFor: 'nuevaCategoriaPadreCrearProducto' },
					...
					__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
						'div',
						{ className: 'col-md-6' },
						__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('input', { className: 'form-control', name: 'nuevaCategoriaPadreCrearProducto', id: 'createProductNewFatherCategory', required: true })
					)
				);
			} else {
				return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
					...
					__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
						...
						__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
							'label',
							{ htmlFor: 'categoriaCrearProducto' },
							'Categoria'
						)
					),
					__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
						...
						__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
							'select',
							{ className: 'form-control', value: this.state.valCategory, name: 'categoriaCrearProducto', id: this.props.idSelectCategory, onChange: this.handlerChangeCategory },
		...
		key: 'renderOptionsFatherCategories',
		value: function renderOptionsFatherCategories() {
			var opts = [];
			this.props.fatherCategories.forEach(function (father) {
				opts.push(__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
					'option',
					{ value: father.id, key: "optFatherCategory-" + father.id },
					father.name
				));
			});
			return opts;
			...
			$.ajax({
				...
				success: function (response) {
					response.categories.forEach(function (cate) {
						opts.push(__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
							'option',
							{ value: cate.id, key: "categoryOpt-" + cate.id },
							cate.name
						));
					});
		...
		key: 'handlerChangeCategory',
		value: function handlerChangeCategory(ev) {
			...
			$.ajax({
				...
				success: function (response) {
					...
					response.subcategories.forEach(function (sub) {
						opts.push(__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
							'option',
							{ value: sub.id, key: "optSubCat-" + sub.id },
							sub.name
						));
					});
		...
		key: 'toggleInputOtherCategory',
		value: function toggleInputOtherCategory() {
			if (this.state.otherCategory) {
				return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
					...
					__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
						...
						__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
							'label',
							{ htmlFor: 'nuevaCategoriaCrearProducto' },
							'Nombre categoria'
						)
					),
					__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
						'div',
						{ className: 'col-md-6' },
						__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('input', { className: 'form-control', name: 'nuevaCategoriaCrearProducto', id: 'createProductNewCategory', required: true })
					)
				);
			}
		}
		...
		key: 'handlerChangeSubCategory',
		value: function handlerChangeSubCategory(ev) {
			var sel = ev.target.value;
		...
		key: 'renderSelectSubCategory',
		value: function renderSelectSubCategory() {
			if (!this.state.otherCategory) {
				return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
					'div',
					{ className: 'row m-t-xs' },
					__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
						...
						__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
							'label',
							{ htmlFor: 'subCategoriaCrearProducto' },
							'Sub-categoria'
						)
					),
					__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
						...
						__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
							'select',
							{ className: 'form-control', value: this.state.valsubcategory, name: 'subCategoriaCrearProducto', id: 'createProductSubCategory', onChange: this.handlerChangeSubCategory },
							__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('option', { value: '' }),
		...
		key: 'toggleInputOtherSubCategory',
		value: function toggleInputOtherSubCategory() {
			if (this.state.otherSubCategory) {
				return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
					...
					__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
						...
						__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
							'label',
							{ htmlFor: 'nuevaSubCategoriaCrearProducto' },
					...
					__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
						'div',
						{ className: 'col-md-6' },
						__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('input', { className: 'form-control', name: 'nuevaSubCategoriaCrearProducto', id: 'createProductNewSubCategory', required: true })
					)
				);
			}
		}
		...
		key: 'handlerChangeMetaDescription',
		value: function handlerChangeMetaDescription(ev) {
		...
		key: 'renderOptionsBrands',
		value: function renderOptionsBrands() {
			var opts = [];
			this.props.brands.forEach(function (brand) {
				opts.push(__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
					'option',
					{ value: brand.id, key: "optBrand-" + brand.id },
					brand.name
				));
			});
			return opts;
		...
		key: 'handlerChangeBrand',
		value: function handlerChangeBrand(ev) {
			var sel = ev.target.value;
			...
			if (this.state.otherBrand) {
				return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
					...
					__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
						...
						__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
							'label',
							{ htmlFor: 'nombreMarcaCrearProducto' },
							'Nueva marca'
						)
					),
					__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
						'div',
						{ className: 'col-md-8' },
						__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('input', { className: 'form-control', name: 'nombreMarcaCrearProducto', id: 'createProductNewBrand', required: true })
					)
				);
			}
		}
		...
		key: 'buildOptsTags',
		value: function buildOptsTags() {
			var opt = [];
			this.props.tags.forEach(function (tag) {
				opt.push(__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
					'option',
					{ value: tag.id, key: "tagOpt-" + tag.id },
					tag.name
				));
			});
			return opt;
		...
		key: 'handlerChangeMoreTags',
		value: function handlerChangeMoreTags(ev) {
		...
		//maneja el onChage del switch que indica que es un accessorio

	}, {
		key: 'handlerChangeTypeAccessory',
		value: function handlerChangeTypeAccessory(ev) {
			var opt = document.getElementById(this.props.switchAccessory),
			    sel = opt.checked;
			sel = !sel;

			if (sel) {
				this.setState({ valHaveAccessory: false }); //si es un accesorio quitamos el select de elegir accesorios

				var category = document.getElementById(this.props.idSelectCategory).value;
				if (category != "") {
					this.setState({ currentCategory: category });
				}
			}

			this.setState({ valAccessory: sel });
		}
		...
		value: function handlerChangeName(ev) {
		...
		key: 'handlerChangePrice',
		value: function handlerChangePrice(ev) {
			var val = ev.target.value;
		...
		key: 'toogleMoreTags',
		value: function toogleMoreTags() {
			if (this.state.moreTags) {
				return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(TagInput, null);
			}
		}
		...
		key: 'renderInputId',
		value: function renderInputId() {
			if (this.props.editOrCreate == "edit") {
				return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('input', { type: 'hidden', name: 'editProduct_id', id: 'editProduct_id', value: this.state.productEditId, required: true });
			}
		}
		...
		key: 'renderSwitchShowProduct',
		value: function renderSwitchShowProduct() {
			if (this.props.editOrCreate == "edit") {
				return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
					'div',
					{ className: 'row m-t-xs' },
					...
					__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
						...
						__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
							...
							__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('input', { type: 'checkbox', name: 'mostrarProducto', className: 'switchOnOff-checkbox', id: 'switchShowProdutEdit' }),
							__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('label', { className: 'switchOnOff-label', htmlFor: 'switchShowProdutEdit' })
						)
					)
				);
			}
		...
		key: 'handlerChangeHaveAccessory',
		value: function handlerChangeHaveAccessory(ev) {
			var opt = document.getElementById(this.props.switchHaveAccesories),
			    sel = opt.checked;
			this.setState({ valHaveAccessory: !sel });
		}

		//si el state valHaveAccesory es true renderiza un select multiple para adjuntar accesorios al producto

	}, {
		key: 'renderSelectAccessories',
		value: function renderSelectAccessories() {
			if (this.state.valHaveAccessory) {
				return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(AccessoriesInput, { idAccesories: this.props.idAccesories,
					category: this.state.currentCategory,
					getAccessories: this.props.getAccessories });
			}
		}

		//si el state valAccessoy (si es un accesorio el producto que se esta creando) renderizamos el select que muestra los productos a los que se le puede agregar

	}, {
		key: 'renderSelectProductsOfAccessory',
		value: function renderSelectProductsOfAccessory() {
			if (this.state.valAccessory) {
				return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(ProductsOfAccessory, { idProductsOfAccesories: this.props.idProductsOfAccesories,
					idSelectCategory: this.props.idSelectCategory,
					category: this.state.currentCategory,
					routeProductsOfAccessory: this.props.routeProductsOfAccessory });
			}
		}

		//renderiza un switch para preguntar al usuario si tiene accesorior que relacionar

	}, {
		key: 'renderSwitch',
		value: function renderSwitch() {
			if (!this.state.valAccessory) {
				//si no es un accesorio
				return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
					'div',
					{ className: 'row m-t-xs' },
					__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
					...
					__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
						...
						__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
							'div',
							{ className: 'switchOnOff' },
							__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('input', { type: 'checkbox', name: 'haveAccessoriesCrearProducto', className: 'switchOnOff-checkbox', id: this.props.switchHaveAccesories, checked: this.state.valHaveAccessory, onChange: this.handlerChangeHaveAccessory }),
							__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('label', { className: 'switchOnOff-label', htmlFor: this.props.switchHaveAccesories, onClick: this.handlerChangeHaveAccessory })
						),
						__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
							'small',
							null,
							'Marque esta opci\xF3n si el producto tiene accesorios.'
						)
					)
				);
			}
		...
		key: 'renderInputType',
		value: function renderInputType() {
			if (this.props.editOrCreate == "edit") {
				return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('input', { type: 'hidden', defaultValue: this.state.type, id: 'editTypeElement', name: 'editTypeElement' });
			}
		}
		...
		value: function renderTags() {
			...
			if (this.state.tags.length > 0) {
				//si hay tags, los renderizamos
				var tags = [];
				this.state.tags.forEach(function (tag) {
					tags.push(__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
						'li',
						{ key: "liTag-" + tag.id },
						__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
							'a',
							{ 'data-id': tag.id, onClick: _this8.ajaxQuitTag },
							__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('i', { className: 'fa fa-tag', 'data-id': tag.id }),
							' ',
							tag.name,
							' ',
							__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('i', { className: 'fa fa-times', 'data-id': tag.id })
						)
					));
				});
				...
				return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
					...
					__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
						'ul',
						{ className: 'tag-list', style: padding0 },
						tags
					)
				);
			}
		...
		key: 'ajaxDeleteProductOfAccessory',
		value: function ajaxDeleteProductOfAccessory(ev) {
			ev.preventDefault();
		...
		//renderiza los productos que se le han añadido a un accesorio, siempre y cuando este en el formulario de edicion
		//y sea un accesorio

	}, {
		key: 'renderProductsByAccessory',
		value: function renderProductsByAccessory() {
			var _this9 = this;

			//  si el producto es accesorio       si esta establecido como accesorio  si se le pusieron productos
			if (this.state.type == "accessory" && this.state.valAccessory && this.state.renderProductsAttach) {
				var tagsPro = [];
				this.state.shop_products.forEach(function (propduct) {
					tagsPro.push(__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
						'li',
						{ key: "liProductOfAccessory-" + propduct.id },
						__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
							'a',
							{ 'data-id': propduct.id, onClick: _this9.ajaxDeleteProductOfAccessory },
							__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('i', { className: 'fa fa-tag' }),
							' ',
							propduct.name,
							' ',
		...
		key: 'ajaxQuitAccessory',
		value: function ajaxQuitAccessory(ev) {
			ev.preventDefault();
		...
		//renderiza los accessorios de un producto, en caso de tenerlos

	}, {
		key: 'renderAccessories',
		value: function renderAccessories() {
			var _this10 = this;

			if (this.state.valHaveAccessory && this.state.shop_accessories.length > 0) {
				//shop_accessories
				var accessories = [];
				this.state.shop_accessories.forEach(function (accesory) {
					accessories.push(__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
						'li',
						{ key: "liAccessoryOfProduct-" + accesory.id },
						__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
							'a',
							{ 'data-id': accesory.id, onClick: _this10.ajaxQuitAccessory },
							__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('i', { className: 'fa fa-tag' }),
							' ',
							accesory.name,
							' ',
		...
		value: function componentDidMount() {
			...
			$('#' + this.props.idFieldDescription).summernote({
				...
				['Paragraph style', ['style']], ['style', ['bold', 'italic', 'underline', 'clear']], ['Font Style', ['fontname', 'fontsize', 'color']], ['para', ['ul', 'ol', 'paragraph']], ['insert', ['link', 'video', 'table']]]
			});
			...
			$("#" + this.props.idFielTags).chosen().change(function () {
				var tag = $("#" + _this11.props.idFielTags).val();
				_this11.setState({ valueTags: tag });
			});
		...
		value: function componentWillReceiveProps(nextProps) {
			if (nextProps.productEdit != null && nextProps.editOrCreate == "edit") {
				...
				nextProps.productEdit.shop_tags.forEach(function (tag) {
		...
		value: function render() {
			return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
				'form',
				{ id: this.props.formId, onSubmit: this.props.submitForm, encType: 'multipart/form-data' },
				__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
					'div',
					{ className: 'row' },
					__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
						...
						__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
							...
							__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
								...
								__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
									'select',
									{ name: 'categoriaPadreCrearProducto', id: 'createProductFatherCategory', value: this.state.valueFathercate, onChange: this.handlerChangeFatherCategory },
									__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
										'option',
						...
						__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
							...
							__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
								...
								__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
									'label',
									{ htmlFor: 'metaDescripcionCrearProducto' },
									'Meta description: ',
									__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
										'small',
										{ className: 'help-block m-b-none' },
										'Esta descripcion no ser\xE1 mostrada en la pagina al visitante, si embargo es necesaria para ser encontrada por los buscadores.'
									)
								),
								__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('textarea', { className: 'form-control', name: 'metaDescripcionCrearProducto', id: 'createProductDescriptionMeta', value: this.state.valueMetaDescription, onChange: this.handlerChangeMetaDescription, required: true })
							)
						),
						this.renderTags(),
						__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
							...
							__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
								...
								__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
									'select',
									{ id: this.props.idFielTags, name: 'tagsCrearProducto[]', defaultValue: this.state.valueTags, className: 'chosen-select', 'data-placeholder': 'Selcciona los tags', multiple: true },
									this.buildOptsTags()
								)
							)
						),
						__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
							...
							__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
								...
								__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
									'div',
									{ className: 'switchOnOff' },
									__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('input', { type: 'checkbox', name: 'crearTagsCrearProducto', className: 'switchOnOff-checkbox', id: this.props.switchMoreTagsId, defaultChecked: this.state.valMoreTags }),
									__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('label', { className: 'switchOnOff-label', htmlFor: this.props.switchMoreTagsId, onClick: this.handlerChangeMoreTags })
								)
							)
						),
						this.toogleMoreTags(),
						...
						__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
							...
							__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
								...
								__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
									'div',
									{ className: 'switchOnOff' },
									__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('input', { type: 'checkbox', name: 'accesorioCrearProducto', className: 'switchOnOff-checkbox', id: this.props.switchAccessory, defaultChecked: this.state.valAccessory }),
									__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('label', { className: 'switchOnOff-label', htmlFor: this.props.switchAccessory, onClick: this.handlerChangeTypeAccessory })
								),
								__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
									'small',
									null,
									'Marque esta opci\xF3n si el producto que esta creando es un accesorio.'
								)
							)
						),
						this.renderProductsByAccessory(),
						this.renderSelectProductsOfAccessory(),
						this.renderSwitch(),
						this.renderAccessories(),
						this.renderSelectAccessories()
					),
					__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
						'div',
						{ className: 'col-md-8' },
						__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
							...
							__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
								'div',
								{ className: 'col-md-8' },
								__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('input', { className: 'form-control', name: 'nombreCrearProducto', id: 'createProductName', value: this.state.valueName, onChange: this.handlerChangeName, required: true })
							)
						),
						__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
							'div',
							...
							__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
								...
								__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
									'label',
									{ htmlFor: 'descripcionCrearProducto' },
									'Descripci\xF3n:'
								),
								__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('textarea', { className: 'form-control', name: 'descripcionCrearProducto', id: this.props.idFieldDescription, required: true })
							)
						),
						__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
							'div',
							...
							__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
								...
								__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
									'select',
									{ className: 'form-control', name: 'marcaCrearProducto', id: 'createProductMarca', value: this.state.valueMarca, onChange: this.handlerChangeBrand },
									__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('option', { value: '' }),
						...
						__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
							...
							__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
								...
								__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
									...
									__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('input', { className: 'form-control ponerPuntos', name: 'precioCrearProducto', id: this.props.editOrCreate == "create" ? "createProductPrice" : "editProductPrice", value: this.state.valuePrice, onChange: this.handlerChangePrice, required: true })
								)
							)
						),
						__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
							...
							__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
								...
								__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
									'div',
									{ className: 'switchOnOff' },
									__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('input', { type: 'checkbox', name: 'mostrarPrecioCrearProducto', className: 'switchOnOff-checkbox', defaultChecked: this.state.valueCheckPrice, id: this.props.switchShowPriceId }),
									__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('label', { className: 'switchOnOff-label', htmlFor: this.props.switchShowPriceId })
								)
							)
						),
						this.renderInputId(),
				...
				__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
					...
					__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
						'div',
						{ className: 'col-md-12' },
						__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('input', { type: 'submit', className: 'btn btn-primary pull-right', value: 'Guardar' })
					)
				)
			);
		}
...
var TagInput = function (_React$Component5) {
	_inherits(TagInput, _React$Component5);
		...
		value: function render() {
			return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
				...
				__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
					'div',
					{ className: 'col-md-12' },
					__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('select', { multiple: true, 'data-role': 'tagsinput', className: 'form-control', name: 'agregarTagsCrearProducto[]', id: 'createProductAgregarTags', tabIndex: '-1' })
				)
			);
		}
	}]);
...
var AccessoriesInput = function (_React$Component6) {
	_inherits(AccessoriesInput, _React$Component6);

	function AccessoriesInput(props) {
		_classCallCheck(this, AccessoriesInput);

		var _this13 = _possibleConstructorReturn(this, (AccessoriesInput.__proto__ || Object.getPrototypeOf(AccessoriesInput)).call(this, props));

		_this13.state = { accessories: [],
			valueAccesories: [],
			category: _this13.props.category
		};
		return _this13;
	}
	...
	_createClass(AccessoriesInput, [{
		key: 'ajaxGetAccessories',
		value: function ajaxGetAccessories() {
				...
				$.ajax({
					...
					success: function (response) {
						...
						response.accessories.forEach(function (accessory) {
							opt.push(__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
								'option',
								{ value: accessory.id, key: "optAccessory-" + accessory.id },
								accessory.name
							));
						});
		...
		value: function componentDidMount() {
			...
			$("#" + this.props.idAccesories).chosen().change(function () {
				var tag = $("#" + _this14.props.idAccesories).val();
				console.log("ejecutado", tag);
				_this14.setState({ valueAccesories: tag });
			});
		}
	}, {
		key: 'componentWillReceiveProps',
		...
		value: function render() {
			return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
				...
				__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
					...
					__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
						'label',
						{ htmlFor: 'selectAccessoriesCrearProducto' },
						'Accesorios:'
					),
					__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
						'select',
						{ id: this.props.idAccesories, name: 'AccessoriesProducto[]', defaultValue: this.state.valueAccesories, className: 'chosen-select', 'data-placeholder': 'Selcciona los accesorios', multiple: true },
...
var ProductsOfAccessory = function (_React$Component7) {
	_inherits(ProductsOfAccessory, _React$Component7);

	function ProductsOfAccessory(props) {
		_classCallCheck(this, ProductsOfAccessory);

		var _this15 = _possibleConstructorReturn(this, (ProductsOfAccessory.__proto__ || Object.getPrototypeOf(ProductsOfAccessory)).call(this, props));

		_this15.state = { products: [],
			valueProducts: [],
			category: _this15.props.category };
		return _this15;
	}
	...
	_createClass(ProductsOfAccessory, [{
		key: 'ajaxGetProductsOfAccesory',
		value: function ajaxGetProductsOfAccesory() {
			if (this.state.category != "" && this.state.category != "otro") {
				$.ajax({
					...
					success: function (response) {
						var opt = [];
						response.productsToAccesory.forEach(function (product) {
							opt.push(__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
								'option',
								{ value: product.id, key: "optProduct-" + product.id },
								product.name
							));
						});
		...
		value: function componentDidMount() {
			...
			$("#" + this.props.idProductsOfAccesories).chosen().change(function () {
				var tag = $("#" + _this16.props.idProductsOfAccesories).val();
				_this16.setState({ valueProducts: tag });
			});
		}
	}, {
		key: 'componentWillReceiveProps',
		...
		value: function render() {
			return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
				...
				__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
					...
					__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
						'select',
						{ id: this.props.idProductsOfAccesories, name: 'ProductosDeAccesorio[]', defaultValue: this.state.valueProducts, className: 'chosen-select', 'data-placeholder': 'Selcciona los productos', multiple: true },
						this.state.products
					)
				)
			);
	...
	return ProductsOfAccessory;
}(__WEBPACK_IMPORTED_MODULE_0_react___default.a.Component);

//formulario para agregar imagenes a un producto


var FormImages = function (_React$Component8) {
	_inherits(FormImages, _React$Component8);

	function FormImages(props) {
		_classCallCheck(this, FormImages);

		var _this17 = _possibleConstructorReturn(this, (FormImages.__proto__ || Object.getPrototypeOf(FormImages)).call(this, props));

		_this17.state = { 'fieldsPic': ['input-0'], //cundo se agrega un nuevo elemnto a este array, igulmente se renderizaran inputs para fotos
			'showBtnFinish': false //si es true renderiza un boton para
		};

		_this17.appendInputPic = _this17.appendInputPic.bind(_this17); //maneja el onClik de el boton que agrega campos para poner más fotos
		_this17.deleteFieldInput = _this17.deleteFieldInput.bind(_this17); //se encarga de eliminar un input de foto
		_this17.showBtnFinish = _this17.showBtnFinish.bind(_this17); //establee el state showBtnFinish en true
		return _this17;
	}
	...
	_createClass(FormImages, [{
		key: 'deleteFieldInput',
		value: function deleteFieldInput(e) {
			e.preventDefault();
			var fila = e.target.getAttribute('data-row'),
			    letRows = [];

			this.state.fieldsPic.forEach(function (field) {
		...
		key: 'renderBtnFinish',
		value: function renderBtnFinish() {
			if (this.state.showBtnFinish) {
				return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
					'button',
					{ className: 'btn btn-default pull-right', onClick: this.props.finishCreate },
					'Finalizar'
				);
			}
		}
		...
		key: 'appendInputPic',
		value: function appendInputPic(ev) {
			ev.preventDefault();
		...
		value: function render() {
			...
			return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
				...
				__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
					'div',
					{ className: 'row m-t-xs' },
					this.state.fieldsPic.map(function (input) {
						return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(RowInputPic, { row: input,
							deleteFieldInput: _this18.deleteFieldInput,
							key: input,
							defaultImg: _this18.props.defaultImg,
							routeSubmit: _this18.props.routeSubmit,
							routeDeleteImg: _this18.props.routeDeleteImg,
							productCreated: _this18.props.productCreated,
							productCreatedType: _this18.props.productCreatedType,
							showBtnFinish: _this18.showBtnFinish,
							update: false,
							imgId: false });
					}),
					__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
						...
						__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
							'button',
							{ className: 'btn btn-default pull-right', onClick: this.appendInputPic },
							'Agregar foto'
						),
...
var RowInputPic = function (_React$Component9) {
	_inherits(RowInputPic, _React$Component9);

	function RowInputPic(props) {
		_classCallCheck(this, RowInputPic);

		var _this19 = _possibleConstructorReturn(this, (RowInputPic.__proto__ || Object.getPrototypeOf(RowInputPic)).call(this, props));

		_this19.state = { options: { aspectRatio: 1 / 1,
				viewMode: 1,
				dragMode: 'move',
				autoCropArea: 0.65,
				restore: false,
				...
				preview: "#preview-img-" + _this19.props.row }
		};

		_this19.deleteImg = _this19.deleteImg.bind(_this19);
		return _this19;
	}
	...
	_createClass(RowInputPic, [{
		key: 'renderBtnDelete',
		value: function renderBtnDelete() {
			if (this.props.update) {
				return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
					'button',
					{ className: 'btn btn-danger', onClick: this.deleteImg },
					'Eliminar'
				);
			}
		}
		...
		value: function componentDidMount() {
			var image = document.getElementById('grap' + this.props.row),
			    ...
			    cropper = new __WEBPACK_IMPORTED_MODULE_2_cropperjs__["a" /* default */](image, this.state.options),
			...
			if (window.FileReader) {
				...
				$inputImage.change(function () {
					...
					if (/^image\/\w+$/.test(file.type)) {
						...
						$inputImage.val("");
						cropper.destroy();
						cropper = new __WEBPACK_IMPORTED_MODULE_2_cropperjs__["a" /* default */](image, options);
				...
				$loadImge.on("click", function (ev) {
					...
					cropper.getCroppedCanvas().toBlob(function (blob) {
						...
						$.ajax({
							...
							contentType: false,
							xhr: function xhr() {
								//esta funcion permite la comunicación con el servidor durante la carga
		...
		value: function render() {
			return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
				'div',
				{ className: 'row m-t-xs', id: "contCroperImg-" + this.props.row },
				__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
					'div',
					{ className: 'col-xs-8' },
					__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('img', { id: "grap" + this.props.row, style: maxImage, src: this.props.defaultImg })
				),
				__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
					'div',
					{ className: 'col-xs-4' },
					__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
						...
						__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
							'div',
							{ className: 'img-preview img-preview-sm', id: "preview-img-" + this.props.row },
							__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('img', { src: this.props.defaultImg })
						),
						__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
							'div',
							{ className: 'btn-group m-t-xs m-b-xs' },
							this.renderBtnDelete(),
							__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
								'label',
								{ title: 'Upload image file', htmlFor: "inputImage-" + this.props.row, className: 'btn btn-primary' },
								__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('input', { type: 'file', accept: 'image/*', name: 'file', id: "inputImage-" + this.props.row, className: 'hide', onChange: this.changeImage }),
								'Selecionar imagen'
							),
							__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
								'button',
								{ className: 'btn btn-primary', id: "btnLoad-" + this.props.row },
								'Cargar ',
						...
						__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
							...
							__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
								'div',
								{ id: "barProgress" + this.props.row, className: 'progress-bar progress-bar-info progress-bar-striped active', role: 'progressbar', 'aria-valuenow': '0', 'aria-valuemin': '0', 'aria-valuemax': '100', style: startProgressBar },
								__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
									'span',
									{ className: 'sr-only' },
									'0% Complete'
...
var ModalEdit = function (_React$Component10) {
	_inherits(ModalEdit, _React$Component10);

	function ModalEdit() {
		_classCallCheck(this, ModalEdit);

		return _possibleConstructorReturn(this, (ModalEdit.__proto__ || Object.getPrototypeOf(ModalEdit)).apply(this, arguments));
	}
	...
	_createClass(ModalEdit, [{
		...
		value: function renderAForm() {
			if (this.props.pageFormEdit == "first") {
				...
				return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(FormEditImages, { productEdit: this.props.productEdit,
					productCreatedType: this.props.productCreatedType,
		...
		value: function render() {
			return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
				'div',
				{ className: 'modal inmodal fade', id: 'modalEditProduct', tabIndex: '-1', role: 'dialog', 'aria-labelledby': 'exampleModalLabel' },
				__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
					'div',
					{ className: 'modal-dialog modal-xxl', role: 'document' },
					__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
						'div',
						...
						__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
							...
							__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
								...
								'Editar producto ',
								this.props.productEdit != null ? this.props.productEdit.name : ""
							)
						),
						__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
							'div',
...
var FormEditImages = function (_React$Component11) {
	_inherits(FormEditImages, _React$Component11);

	function FormEditImages(props) {
		_classCallCheck(this, FormEditImages);

		var _this21 = _possibleConstructorReturn(this, (FormEditImages.__proto__ || Object.getPrototypeOf(FormEditImages)).call(this, props));

		_this21.state = { fieldsPic: [],
			shop_images: _this21.props.productEdit.type == "product" ? _this21.props.productEdit.shop_images : _this21.props.productEdit.shop_accessoryimages };

		_this21.appendInputPic = _this21.appendInputPic.bind(_this21); //maneja el onClik de el boton que agrega campos para poner más fotos
		_this21.deleteFieldInput = _this21.deleteFieldInput.bind(_this21);
		_this21.showBtnFinish = _this21.showBtnFinish.bind(_this21);
		return _this21;
	}
	...
	_createClass(FormEditImages, [{
		...
		value: function buildImage() {
			...
			this.props.productEdit.shop_images.forEach(function (product) {

				row.push();

				iteracion++;
				if (iteracion == 5) {
					images.push(__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
						'div',
						{ className: 'row', key: "rowProduct-" + iteracion + "-" + product.id },
						row
					));
		...
		key: 'deleteFieldInput',
		value: function deleteFieldInput() {}
	}, {
		key: 'showBtnFinish',
		value: function showBtnFinish() {}
	}, {
		...
		key: 'renderFieldsImges',
		value: function renderFieldsImges() {
			var _this22 = this;

			var render = [];
			this.state.shop_images.forEach(function (img) {

				render.push(__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(RowInputPic, { row: "inputEdit-" + img.id,
					deleteFieldInput: _this22.deleteFieldInput,
					key: "inputEdit-" + img.id,
					defaultImg: img.route,
					routeSubmit: _this22.props.routeEditImg,
					routeDeleteImg: _this22.props.routeDeleteImg,
					productCreated: _this22.props.productEdit.id,
					productCreatedType: _this22.props.productCreatedType,
					showBtnFinish: _this22.showBtnFinish,
					update: true,
					imgId: img.id }));
			});
			return render;
		...
		value: function render() {
			...
			return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
				...
				this.state.fieldsPic.map(function (input) {
					return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(RowInputPic, { row: input,
						deleteFieldInput: _this23.deleteFieldInput,
						key: input,
						defaultImg: _this23.props.defaultImg,
						routeSubmit: _this23.props.routeSubmit,
						routeDeleteImg: _this23.props.routeDeleteImg,
						productCreated: _this23.props.productEdit.id,
						productCreatedType: _this23.props.productCreatedType,
						showBtnFinish: _this23.showBtnFinish,
						update: false,
						imgId: false });
				}),
				__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
	...
	return FormEditImages;
}(__WEBPACK_IMPORTED_MODULE_0_react___default.a.Component);

setTimeout(function () {
	__WEBPACK_IMPORTED_MODULE_1_react_dom___default.a.render(__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(Main, { fatherCategories: fatherCategories,
		brands: brands,
		tags: tags,
		routes: routes,
...
module.exports = function () {
	...
	_createClass(Helpers, [{
		...
		key: "getParameterByUrlName",
		value: function getParameterByUrlName(name) {
		...
		key: "ponerPuntosEnNumeros",
		value: function ponerPuntosEnNumeros() {
		...
		key: "formatoNumero",
		value: function formatoNumero(nStr) {
			nStr += '';
			var x = nStr.split('.');
			var x1 = x[0];
		...
		key: "toDateColombiaString",
		value: function toDateColombiaString(date) {
		...
		key: "toDateColombiaShortString",
		value: function toDateColombiaShortString(date) {
		...
		key: "toDateColombiaExtraShortString",
		value: function toDateColombiaExtraShortString(date) {
			var dateSplit = date.split('-');
		...
		key: "getFullMonthName",
		value: function getFullMonthName(month) {
		...
		key: "swapArrayIndices",
		value: function swapArrayIndices(myArr, indexOne, indexTwo) {
